      ...
      <div className="flex items-center">
        <Link href="/" className="group flex flex-col items-start leading-none">
          <div className="flex items-center gap-2">
            {/* Main Logo Icon - Slightly larger to anchor the text */}
            <span className="text-gray-900 font-light text-3xl tracking-tighter leading-none">
            [ · ]
            </span>
            
            {/* ON CUE - Sized to match the bracket height */}
            <span className="text-[18px] font-light tracking-[0.2em] text-gray-700 uppercase leading-none self-center pt-1">
              On Cue
            </span>
          </div>

          {/* BETA - Positioned underneath the brackets */}
          <span className="text-[9px] font-bold text-gray-700 tracking-[0.4em] uppercase mt-1 ml-1">
            Beta
          </span>
        </Link>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <SignedOut>
          <SignInButton mode="modal">
            <button className="text-sm font-bold text-gray-600 hover:text-black transition">Log in</button>
          </SignInButton>
          
          <div className="h-4 w-[1px] bg-gray-300"></div>

          <Link href="/creators">
            <button className="text-sm font-bold text-gray-600 hover:text-black transition">Join as Creator</button>
          </Link>
